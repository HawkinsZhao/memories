...
Chinese.onclick = function(){
	window.location.href="./BJ.html?Subject=Chinese";
}
Math.onclick = function(){
	window.location.href="./BJ.html?Subject=Math";
}
English.onclick = function(){
	window.location.href="./BJ.html?Subject=English";
}
WenZong.onclick = function(){
	window.location.href="./BJ.html?Subject=WenZong";
}
Physic.onclick = function(){
	window.location.href="./BJ.html?Subject=Physic";
}
Chem.onclick = function(){
	window.location.href="./BJ.html?Subject=Chem";
}
Biology.onclick = function(){
	window.location.href="./BJ.html?Subject=Biology";
}